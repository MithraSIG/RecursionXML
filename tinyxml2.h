...
namespace tinyxml2
{
    ...
    */
    ...
    public:
        ...
        */
        ...
        // 2023/03/09 : permet de créer des macro XML (&RAP;)
        // Cela nécessite de pouvoir écrire des caractères spétiaux et donc de désactiver les modes caractères spétiaux.
        XMLError SaveFileWithMacro(const char* filename);
        /**
            ...
            an errorID.
        */
        XMLError SaveFile(FILE* fp, bool compact = false, bool with_macro = false);
    ...
    */
    ...
    public:
        ...
        */
        XMLPrinter(FILE* file = 0, bool compact = false, int depth = 0, bool with_macro = false);
        virtual ~XMLPrinter() {}
